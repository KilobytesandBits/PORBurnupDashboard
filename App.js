...
Ext.define('MilestoneTreeModel', {
	...
	fields: [
                ...
                {name: 'AdditionalReferences', mapping: 'AdditionalReferences', type: types.STRING},
       ...
       var valuestreamMilestoneTreePanel = Ext.create('Ext.tree.Panel', {
           ...
           itemId: 'milestonesTreePanel',
            ...
            columns: [{
                    ...
                    {
                        text: 'References',
                        dataIndex: 'AdditionalReferences',
                        flex: 2,
                            ...
                            if(r.get('FormattedID') !== ''){
                                Ext.defer(function () {
                                    Ext.widget('rallybutton', {
                                        renderTo: id,
                                        text: 'View ' + r.get('FormattedID') + ' References',
                                        width: 150,
                                        handler: function () { 
                                                var dialogTitle = r.get('FormattedID') + ': Additional References';
                                                if(r.get('AdditionalReferences') !== null && r.get('AdditionalReferences') !== ''){
